...
import type { IYamlApiFile, IYamlItem, IYamlReference, IYamlReferenceSpec, IYamlSyntax } from '../yaml/IYamlApiFile.js';
import type {
	CommonYamlModel,
	EnumYamlModel,
	FieldYamlModel,
	...
	TypeAliasYamlModel,
	TypeYamlModel,
} from '../yaml/ISDPYamlFile.js';
import path from 'path';
import { Encoding, FileSystem, NewlineKind } from '@rushstack/node-core-library';
